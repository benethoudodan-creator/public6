...
# WELCOME PAGE TITLE
st.title("Welcome to D.A.V.(Device Amount Visualizer)📱")

# INTRODUCTORY TEXT
st.write("""
This application is designed to show the user whats the most amount of money they've spent on their devices.
